 ...
 */
metadata {
	definition (name: "Aeon Multisensor Gen5GF", namespace: "smartthings", author: "SmartThings", runLocally: false, minHubCoreVersion: '000.017.0012', executeCommandsLocally: true) {
